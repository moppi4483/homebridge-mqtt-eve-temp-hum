...
class EVETempHumAccessory {
    ...
    get temperatureName() {
      return this.config.temperatureName || 'Temperatur';
    }
  
    get humidityName() {
      return this.config.humidityName || 'Luftfeuchtigkeit';
    }

    get serialNumber() {
      return this.config.serialNumber != null ? this.config.serialNumber : undefined;
    }
    ...
    getFakeGatoHistoryService() {
      ...
      const serialNumber = this.config.serialNumber;
    ...
    getInformationService() {
      const accessoryInformation = new Service.AccessoryInformation()
        ...
        .setCharacteristic(Characteristic.FirmwareRevision, "1.0.6");
      if (this.config.serialNumber != null) {
        accessoryInformation.setCharacteristic(Characteristic.SerialNumber, this.config.serialNumber);
      }
